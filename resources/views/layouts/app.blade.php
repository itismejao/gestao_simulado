...
<head>
    ...
    <meta name="description" content="Sistema de Gestão de simulados"/>
    <meta name="author" content="João Marcos de Siqueira Neto"/>
    <meta name="keywords" content="sistema, simulado" />
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('curso') }}">
                                        Curso
                                    </a>
                                    <a class="dropdown-item" href="{{ route('sala') }}">
                                        Sala
                                    </a>
