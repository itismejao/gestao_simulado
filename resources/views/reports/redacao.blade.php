...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Folha de Redação') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" target="_blank" action="{{ route("processarredacao") }}"  enctype="multipart/form-data">
                        @csrf
